...
contextBridge.exposeInMainWorld('petOffice', {
  ...
  cloneLegacyMission: id => ipcRenderer.invoke('mission:cloneLegacy', id),
  publishMissionMemory: id => ipcRenderer.invoke('mission:publishMemory', id),
  rufloHealth: projectId => ipcRenderer.invoke('ruflo:health', projectId),
  installRuflo: () => ipcRenderer.invoke('ruflo:install'),
  repairRuflo: () => ipcRenderer.invoke('ruflo:repair'),
  ...
  setModel: (petId, model, mode) => ipcRenderer.invoke('pet:model', { petId, model, mode }),
